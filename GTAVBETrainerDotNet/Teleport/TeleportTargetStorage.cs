...
namespace GTAVBETrainerDotNet.Teleport
{
    ...
    public static class TeleportTargetStorage
    {
        ...
        {
            new TeleportTarget ( Utils.CSML("Michael's Safehouse", "麦可的家"), -827.138f, 176.368f, 70.4999f ),
            new TeleportTarget ( Utils.CSML("Michael's Safehouse Inside", "麦可的家内部"), -813.603f, 179.474f, 72.1548f ),
            new TeleportTarget ( Utils.CSML("Franklin's Safehouse 1", "富兰克林的家1"), -18.0355f, -1456.94f, 30.4548f ),
            new TeleportTarget ( Utils.CSML("Franklin's Safehouse 1 Inside", "富兰克林的家1内部"), -14.3803f, -1438.51f, 31.1073f ),
            new TeleportTarget ( Utils.CSML("Franklin's Safehouse 2", "富兰克林的家2"), 10.8766f, 545.654f, 175.419f ),
            new TeleportTarget ( Utils.CSML("Franklin's Safehouse 2 Inside", "富兰克林的家2内部"), 7.11903f, 536.615f, 176.028f ),
            new TeleportTarget ( Utils.CSML("Trevor's Safehouse 1", "崔佛的家1"), 1982.13f, 3829.44f, 32.3662f ),
            new TeleportTarget ( Utils.CSML("Trevor's Safehouse 1 Inside", "崔佛的家1内部"), 1972.61f, 3817.04f, 33.4278f ),
            new TeleportTarget ( Utils.CSML("Trevor's Safehouse 2", "崔佛的家2"), -1157.05f, -1512.73f, 4.2127f ),
            new TeleportTarget ( Utils.CSML("Trevor's Safehouse 2 Inside", "崔佛的家2内部"), -1151.77f, -1518.14f, 10.6327f ),
            new TeleportTarget ( Utils.CSML("Trevor's Safehouse 3", "崔佛的家3"), 91.1407f, -1280.65f, 29.1353f ),
            new TeleportTarget ( Utils.CSML("Trevor's Safehouse 3 Inside", "崔佛的家3内部"), 96.1536f, -1290.73f, 29.2664f ),
        };
